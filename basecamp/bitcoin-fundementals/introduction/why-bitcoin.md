...
Bitcoin was the first digital currency to solve the double-spending problem in a **decentralized** way. It overcomes this issue with a **peer-to-peer distributed timestamp server.** Lot of big words … i know
